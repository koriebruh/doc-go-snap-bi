...
kebalikan dari signing sisi klien di [`HeaderBuilder`](/id/concepts/headers)
dan [`TokenManager`](/id/concepts/authentication).
...
<CardGroup cols={2}>
  ...
  <Card title="Bulk Cash In" icon="hand-coins" href="/id/reference/transfer-credit/bulk-cashin">
    Contoh nyata sebuah tipe notifikasi masuk untuk diverifikasi dan di-unmarshal.
  </Card>
</CardGroup>
