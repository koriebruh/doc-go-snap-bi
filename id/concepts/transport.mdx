...
(lihat [Errors](/id/concepts/errors)).
...
<CardGroup cols={2}>
  <Card title="Errors" icon="triangle-alert" href="/id/concepts/errors">
    Mengubah `Envelope` menjadi sukses/gagal yang pasti dan error bertipe.
  </Card>
  <Card title="Verifying inbound requests" icon="shield-check" href="/id/concepts/webhooks">
