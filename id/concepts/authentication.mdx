...
mode signing transaksi Anda (lihat [Signing](/id/concepts/signing)).
...
<CardGroup cols={2}>
  <Card title="Headers & Signing" icon="key" href="/id/concepts/headers">
    Memakai token yang Anda dapat di sini untuk membangun request transaksi yang ditandatangani.
  </Card>
  <Card title="Registration" icon="id-card" href="/id/reference/registration">
    `GetOAuthURL` dan `AccountBinding` — alur onboarding B2B2C.
  </Card>
</CardGroup>
